...
| [06-ca-tools.md](./06-ca-tools.md) | CA工具 | 20分钟 | ⭐⭐⭐⭐ | caget、caput等 |
| [07-python-epics.md](./07-python-epics.md) | Python接口 | 30分钟 | ⭐⭐⭐⭐ | pyepics使用 |
| [08-database-basics.md](./08-database-basics.md) | 数据库基础 | 30分钟 | ⭐⭐⭐⭐ | .db文件结构 |
| [09-makefile-basics.md](./09-makefile-basics.md) | Makefile基础 | 20分钟 | ⭐⭐⭐ | EPICS构建 |
